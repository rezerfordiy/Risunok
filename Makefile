...
# Project:  Make.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Make.pro
#############################################################################
...
SOURCES       = src/main.cpp \
		...
		src/Graph.cpp \
		src/AStar.cpp \
		src/GraphLoader.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		MainWindow.o \
		Graph.o \
		AStar.o \
...
MyApp.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,first.MyApp,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},first.MyApp,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,MyApp,g" -e "s,@LIBRARY@,MyApp,g" -e "s,\$${EXECUTABLE_NAME},MyApp,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >MyApp.app/Contents/Info.plist

all: Makefile \
		MyApp.app/Contents/PkgInfo \
		MyApp.app/Contents/Info.plist MyApp.app/Contents/MacOS/MyApp
...
moc_MainWindow.cpp: include/MainWindow.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QGraphicsItemGroup \
...
MainWindow.o: src/MainWindow.cpp include/MainWindow.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QGraphicsLineItem \
